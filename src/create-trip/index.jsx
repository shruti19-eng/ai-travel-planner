...
const MAPBOX_TOKEN = import.meta.env.VITE_MAPBOX_ACCESS_TOKEN; // add to .env file
...
//   const [place, setPlace] = useState();
  ...
  const searchPlaces = async (q) => {
    setQuery(q);
    if (q.length < 3) return; // only search after 3 chars
  ...
  return (
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10'>
      ...
      <div className='mt-20 flex flex-col gap-10'>
        ...
        {/* Destination (Mapbox Autocomplete) */}
        <div>
